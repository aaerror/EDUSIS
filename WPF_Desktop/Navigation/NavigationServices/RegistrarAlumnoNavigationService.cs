...
internal class RegistrarAlumnoNavigationService<TViewModel> : INavigationService
	where TViewModel : ObservableObject
{
	...
	public RegistrarAlumnoNavigationService(Func<TViewModel> viewModelFactory, MainWindowNavigationStore navigationStore)
	{
