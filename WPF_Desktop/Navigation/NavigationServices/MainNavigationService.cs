...
internal class MainNavigationService<TViewModel> : INavigationService
	where TViewModel : ObservableObject
{
	...
	public MainNavigationService(Func<TViewModel> viewModelFactory, MainWindowNavigationStore navigationStore)
	{
