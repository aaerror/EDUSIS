...
internal class GestionAlumnosNavigationService<TViewModel> : INavigationService
	where TViewModel : ObservableObject
{
	...
	public GestionAlumnosNavigationService(Func<TViewModel> viewModelFactory, MainWindowNavigationStore navigationStore)
	{
