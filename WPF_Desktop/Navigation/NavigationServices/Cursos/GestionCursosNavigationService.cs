...
internal class GestionCursosNavigationService<TViewModel> : INavigationService
	where TViewModel : ObservableObject
{
	...
	public GestionCursosNavigationService(Func<TViewModel> viewModelFactory, MainWindowNavigationStore navigationStore)
	{
