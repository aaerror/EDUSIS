...
internal class GestionCursantesNavigationService<TViewModel> : INavigationService
	where TViewModel : ObservableObject
{
	...
	public GestionCursantesNavigationService(Func<TViewModel> viewModelFactory, MainWindowNavigationStore navigationStore)
	{
