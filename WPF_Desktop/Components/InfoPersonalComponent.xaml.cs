...
{
	public static readonly DependencyProperty PersonaIDProperty = DependencyProperty.Register(nameof(PersonaID), typeof(string), typeof(InfoPersonalComponent), new PropertyMetadata(string.Empty));
	...
	public string PersonaID
	{
		get
		{
			return (string) GetValue(PersonaIDProperty);
		}
