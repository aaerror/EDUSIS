...
internal class GestionCursantesViewModel : ObservableObject, INotifyDataErrorInfo
{
	#region Servicios
	private readonly IServicioCurso _servicioCursos;
	private readonly IServicioCurricula _servicioMaterias;
	#endregion
	...
	public GestionCursantesViewModel(IServicioCurso servicioCursos, IServicioCurricula servicioMaterias, CursoStore cursoStore, DivisionStore divisionStore)
	{
		...
		//TODO: Verificar ID EMPTY
		var request = new ListarMateriasSegunCurriculaRequest(CursoID: _cursoStore.Curso.CursoID,
															  CurriculaID: Guid.Empty);
		var materias = _servicioMaterias.ListarMateriasSegunCurriculaAsync(request);
